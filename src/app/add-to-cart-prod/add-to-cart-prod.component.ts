...
@Component({
	selector: 'app-add-to-cart-prod',
	templateUrl: './add-to-cart-prod.component.html',
	styleUrls: ['./add-to-cart-prod.component.scss']
})
export class AddToCartProdComponent implements OnInit {
